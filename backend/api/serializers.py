...
class OrderItemSerializer(serializers.Serializer):
    ...
    price = serializers.DecimalField(max_digits=10, decimal_places=2, required=False, allow_null=True, default=0)
    category = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='General')

class OrderSerializer(serializers.Serializer):
    id = ObjectIdField(read_only=True, source='_id')
    order_id = serializers.CharField(read_only=True, required=False)
    user_email = serializers.EmailField(required=False, allow_null=True, default='guest@sjg.com')
    user_name = serializers.CharField(max_length=200, required=False, allow_null=True, default='Guest')
    ...
    shipping_address = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='')
    payment_method = serializers.CharField(max_length=50, required=False, allow_blank=True, allow_null=True, default='offline')
    payment_status = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='pending')
    transaction_id = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='')
    delivery_date = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='')
    delivery_partner = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='')
    tracking_id = serializers.CharField(required=False, allow_blank=True, allow_null=True, default='')
